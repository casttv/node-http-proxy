...
RoutingProxy.prototype.add = function (options) {
  ...
  this.proxies[key].on('timeout', this.emit.bind(this, 'timeout'));
};
...
RoutingProxy.prototype.proxyRequest = function (req, res, options) {
  ...
  var proxyOptions = {};
  proxyOptions.responseHeadersTransform = options.responseHeadersTransform || this.responseHeadersTransform;
  proxyOptions.localAddress = options.localAddress || this.localAddress;

  proxy.proxyRequest(req, res, buffer, proxyOptions);
};
